...
import Student_Portal.com.project.controller.CourseController;
import Student_Portal.com.project.controller.StudentController;
import Student_Portal.com.project.service.Course_Rohan_Service;
import Student_Portal.com.project.service.Invoice_Rohan_Service;
import Student_Portal.com.project.service.Student_Rohan_Service;

class Student_Rohan_Test {
	private StudentController studentController;
    private Student_Rohan_Service studentServiceMock;
    private Invoice_Rohan_Service invoiceServiceMock;
    private RestTemplate restTemplateMock;
    private CourseController courseController;
    private Course_Rohan_Service courseServiceMock;
    
	@BeforeEach
    public void setUp() {
        studentServiceMock = mock(Student_Rohan_Service.class);
        invoiceServiceMock = mock(Invoice_Rohan_Service.class);
        restTemplateMock = mock(RestTemplate.class);
        courseServiceMock = mock(Course_Rohan_Service.class);
        studentServiceMock = mock(Student_Rohan_Service.class);
        
        studentController = new StudentController(studentServiceMock, invoiceServiceMock);
        studentController.restTemplate = restTemplateMock;
        
        courseController = new CourseController(courseServiceMock, studentServiceMock);
    }
